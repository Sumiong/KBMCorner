      ...
      if (email === 'utmmandarinclub@gmail.com' && password === 'admin123') {
        ...
        if (error) {
          ...
          if (error.message.includes('Invalid login credentials')) {
            ...
            console.log('5. Refresh this page and try logging in again');
            console.log('═══════════════════════════════════════════════════════════\n');
            throw new Error('Admin account not found. Please create the admin account in Supabase first. Check console for instructions.');
          }
          throw error;
        }
